...
/**
 * Class contains all the startup logic for the application. DO NOT MODIFY ANYTHING BELOW THIS POINT
 * WITH REGARD TO FUNCTIONALITY YOU MAY MAKE STYLE/REFACTOR MODIFICATIONS AS NEEDED
 */
